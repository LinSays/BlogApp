...
import { EmissionType, EmissionModelType, Categories } from "interfaces";
...
const getTranslationCategory = (category: Categories): string => {
  switch (category) {
    case Categories.automotive:
      return t("UI_AUTOMOTIVE");
